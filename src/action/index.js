...
/* GOOGLE SIGN IN OATH */
export const USER_SIGNIN_GOOGLE = 'USER_SIGNIN_GOOGLE'
export const USER_SIGNIN_GOOGLE_SUCCESS = 'USER_SIGNIN_GOOGLE_SUCCESS'
export const USER_SIGNIN_GOOGLE_FAILURE = 'USER_SIGNIN_GOOGLE_FAILURE'
...
//  CHORES /
export const CHORES_START = 'CHORES_START';
export const CHORES_SUCCESS = 'CHORES_SUCCESS';
export const CHORES_ERROR = 'CHORES_ERROR';

export const EDIT_CHORE_START = 'EDIT_CHORES_START';
export const EDIT_CHORE_SUCCESS = 'EDIT_CHORES_SUCCESS';
export const EDIT_CHORE_ERROR = 'EDIT_CHORES_ERROR';
...
export const URL_START = 'URL_START'
export const URL_SUCCESS = 'URL_START'
export const URL_ERROR = 'URL_START'
